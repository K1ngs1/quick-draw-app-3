...
rand_num = Math.floor((Math.random() * quick_draw_data_set.length) + 1)

console.log(quick_draw_data_set[rand_num]);

sketch = quick_draw_data_set[rand_num];
...
function gotResult(error, result){
    ...
    console.log(result);
    drawn_sketch = result[0];
    document.getElementById("your_sketch") = drawn_sketch;
